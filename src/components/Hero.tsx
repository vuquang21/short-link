        ...
        <div className="max-w-lg">
          ...
          <div className="bg-white rounded-2xl p-1 shadow-lg mb-6">
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <button className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg">
                Rút gọn link
              </button>
            </div>
          </div>
